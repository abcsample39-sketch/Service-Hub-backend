...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [config_1.ConfigModule.forRoot(), auth_1.AuthModule],
...
const register_module_1 = __webpack_require__(10);
const login_module_1 = __webpack_require__(25);
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [register_module_1.RegisterModule, login_module_1.LoginModule, jwt_strategy_1.JwtStrategy],
    })
], AuthModule);
...
const common_1 = __webpack_require__(3);
const register_controller_1 = __webpack_require__(11);
const register_service_1 = __webpack_require__(12);
const database_1 = __webpack_require__(23);
...
const common_1 = __webpack_require__(3);
const register_service_1 = __webpack_require__(12);
const register_user_dto_1 = __webpack_require__(21);
...
const drizzle_service_1 = __webpack_require__(14);
const users_1 = __webpack_require__(18);
const drizzle_orm_1 = __webpack_require__(20);
let RegisterService = class RegisterService {
    ...
    async signup(dto) {
        ...
        const existingUser = await db.query.users.findFirst({
            where: (0, drizzle_orm_1.eq)(users_1.users.email, dto.email),
        });
        if (existingUser) {
        ...
        const [newUser] = await db
            ...
            .returning({ id: users_1.users.id, email: users_1.users.email });
...
const schema = __importStar(__webpack_require__(17));
let DrizzleService = class DrizzleService {
    ...
    onModuleInit() {
        ...
        this.client = (0, node_postgres_1.drizzle)(pool, { schema });
    }
};
...
const pg_core_1 = __webpack_require__(19);
const pg_core_2 = __webpack_require__(19);
const pg_core_3 = __webpack_require__(19);
exports.users = (0, pg_core_3.pgTable)('users', {
...
const passport_1 = __webpack_require__(9);
const login_controller_1 = __webpack_require__(27);
const login_service_1 = __webpack_require__(28);
const database_1 = __webpack_require__(23);
...
exports.LoginService = LoginService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof drizzle_service_1.DrizzleService !== "undefined" && drizzle_service_1.DrizzleService) === "function" ? _a : Object, typeof (_b = typeof jwt_1.JwtService !== "undefined" && jwt_1.JwtService) === "function" ? _b : Object])
], LoginService);
...
let JwtStrategy = class JwtStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    async validate(payload) {
        const db = this.drizzleService.client;
        const user = await db.query.users.findFirst({
            where: (0, drizzle_orm_1.eq)(users_1.users.id, payload.sub),
        });
        if (!user) {
            return null;
        }
